...
/**
 * 互动服务事务性发件箱 (Transactional Outbox) 数据持久化 Mapper。
 */
@Mapper
public interface InteractionOutboxMapper {
     ...
     */
    @Insert("""
            INSERT INTO interaction_outbox(event_id, aggregate_id, event_type, event_version, payload,
            ...
            """)
    int insert(@Param("record") InteractionOutboxRecord record, @Param("occurredAt") Timestamp occurredAt,
     ...
     */
    @Select("""
            SELECT event_id FROM interaction_outbox
